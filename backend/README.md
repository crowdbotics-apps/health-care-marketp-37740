...
## Project Structure
    ...
    ├── health_project_temp_37740  # Django project configurations
...
1. Clone this repo and `cd health_project_temp_37740`
...
2. Clone this repo and `cd health_project_temp_37740`
